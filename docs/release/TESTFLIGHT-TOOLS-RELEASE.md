...
- Opaque App Store icon resources based on the existing cube mark. The 1024×1024 universal icon entry must specify the iOS platform, omit the legacy `scale` field, and compile without missing-icon or unassigned-child warnings.
