...
Briefs and logs: docs/roadmap/M1.1-A-publication-brief.md, M1.1-B-fixtures-brief.md, M1.1-A-worker.log, M1.1-B-worker.log. Dependent editor/runtime work waits for the publication API checkpoint. No implementation checkpoint has yet passed coordinator review.
